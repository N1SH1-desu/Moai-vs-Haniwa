...
//    //AがBを押し出す
//    Vec = DirectX::XMVector3Normalize(Vec);
//    Vec = DirectX::XMVectorScale(Vec, range * 0.5f);
//    DirectX::XMVECTOR centerPos;
//    centerPos = DirectX::XMVectorScale(DirectX::XMVectorAdd(PositionA, PositionB), 0.5f);//真ん中から切り分ける
//
//    PositionB = DirectX::XMVectorAdd(centerPos, Vec);
//    DirectX::XMStoreFloat3(&outPositionB, PositionB);
//
//    PositionA = DirectX::XMVectorSubtract(centerPos, Vec);
...
//        = DirectX::XMVectorSet(positionA.x, 0.0f, positionA.z, 0.0f);
//    DirectX::XMVECTOR PositionB
//        = DirectX::XMVectorSet(positionB.x, 0.0f, positionB.z, 0.0f);
//    DirectX::XMVECTOR Vec = DirectX::XMVectorSubtract(PositionB, PositionA);
//    DirectX::XMVECTOR LengthSq = DirectX::XMVector3LengthSq(Vec);
//    float lengthSq;
//    DirectX::XMStoreFloat(&lengthSq, LengthSq);
...
//    Vec = DirectX::XMVectorScale(Vec, range * 0.5f);
//    DirectX::XMVECTOR centerPos;
//    centerPos = DirectX::XMVectorScale(DirectX::XMVectorAdd(PositionA, PositionB), 0.5f);
//
//    PositionB = DirectX::XMVectorAdd(centerPos, Vec);
//    DirectX::XMStoreFloat3(&outPositionB, PositionB);
//
